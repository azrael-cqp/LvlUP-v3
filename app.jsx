...
const SAVE_FIELDS = ["level","xp","stats","done","doneEx","doneW","doneLessons","totalXp","qC","streak","wLog","socialLog","weightLog","bookTitle","bookPages","bookRead","bookLog","muscleXp","lastDailyReset","lastWeeklyReset","penaltyLog","dailyLessonDone","liftLog","vacation"];
...
const PPL = {
  1:{day:"Monday",type:"PUSH",color:"#ef4444",icon:"🔴",exercises:[
    {name:"DB Incline Bench Press",sets:"4×8-10",muscle:"Upper Chest",desc:"⭐ ROTATED from flat Bench (90kg plateau). Set bench 30-45°. Press dumbbells up from upper chest, squeezing at top. Greater range, fixes plateau."},
    {name:"Bench Press",sets:"3×6-8",muscle:"Chest",desc:"Reduced volume — focus on heavy triples to break 90kg plateau. Lie flat, grip slightly wider than shoulders. Lower to chest, press up explosively."},
    {name:"Overhead Press",sets:"4×8-10",muscle:"Shoulders",desc:"Stand with bar at shoulder height. Press straight overhead, locking elbows at top. Brace core throughout."},
    {name:"Lateral Raises",sets:"4×12-15",muscle:"Side Delts",desc:"Stand with dumbbells at sides. Raise arms out to sides until parallel with floor. Slight bend in elbows, control the weight."},
    {name:"Tricep Pushdowns",sets:"3×12-15",muscle:"Triceps",desc:"Cable machine, rope or bar attachment. Push down until arms are straight, squeeze triceps. Keep elbows pinned to sides."},
    {name:"Overhead Tricep Ext.",sets:"3×12-15",muscle:"Triceps",desc:"Hold dumbbell or rope overhead. Lower behind head by bending elbows, then extend back up. Feel the stretch at bottom."},
  ]},
  2:{day:"Tuesday",type:"PULL",color:"#3b82f6",icon:"🔵",exercises:[
    {name:"Pull-ups / Lat Pulldown",sets:"4×8-10",muscle:"Lats",desc:"Grip bar wider than shoulders. Pull yourself up (or pull bar down) until chin clears bar. Squeeze lats at top, slow negative."},
    {name:"Barbell Rows",sets:"4×8-10",muscle:"Upper Back",desc:"Hinge at hips ~45°, grip bar shoulder-width. Pull bar to lower chest, squeezing shoulder blades together. Keep back flat."},
    {name:"Romanian Deadlift",sets:"3×8-10",muscle:"Hamstrings",desc:"⭐ ADDED: Hamstrings priority. Hold bar at hips, slight knee bend. Hinge forward keeping back flat until stretch in hams. Squeeze glutes to return."},
    {name:"Seated Cable Row",sets:"3×10-12",muscle:"Mid Back",desc:"Sit upright, pull handle to lower chest. Squeeze shoulder blades, then control the release. Don't lean back excessively."},
    {name:"Face Pulls",sets:"3×15-20",muscle:"Rear Delts",desc:"Cable at face height with rope. Pull towards face, separating rope ends. Rotate externally at end. Great for shoulder health."},
    {name:"Barbell Curls",sets:"3×10-12",muscle:"Biceps",desc:"Stand with bar, underhand grip. Curl bar up keeping elbows stationary. Squeeze at top, lower slowly. No swinging."},
    {name:"Hammer Curls",sets:"3×10-12",muscle:"Biceps",desc:"Hold dumbbells with neutral grip (palms facing in). Curl up, squeeze. Works brachialis and forearms too."},
  ]},
  3:{day:"Wednesday",type:"LEGS",color:"#22c55e",icon:"🟢",exercises:[
    {name:"Squats",sets:"4×6-8",muscle:"Quads/Glutes",desc:"Bar on upper back, feet shoulder-width. Sit back and down until thighs are parallel or below. Drive through heels, chest up."},
    {name:"Romanian Deadlift",sets:"4×8-10",muscle:"Hamstrings",desc:"⭐ PRIORITY (Hamstrings 40 XP - weak). Hold bar at hips, slight knee bend. Hinge forward keeping back flat until stretch in hamstrings. Squeeze glutes to return."},
    {name:"Leg Press",sets:"3×10-12",muscle:"Quads",desc:"Feet shoulder-width on platform. Lower weight until knees at ~90°. Press through full foot. Don't lock knees completely."},
    {name:"Walking Lunges",sets:"3×12 ea.",muscle:"Quads/Glutes",desc:"Step forward into lunge, back knee nearly touching floor. Push through front heel to next step. Keep torso upright."},
    {name:"Leg Curls",sets:"4×12-15",muscle:"Hamstrings",desc:"⭐ PRIORITY. Lying or seated machine. Curl weight by bending knees, squeeze hamstrings at peak contraction. Slow negative."},
    {name:"Calf Raises",sets:"5×15-20",muscle:"Calves",desc:"⭐ PRIORITY (Calves 20 XP - weak). 5 sets! Stand on edge of step, heels hanging off. Rise up on toes as high as possible, hold 1 sec, lower below step level for full stretch."},
  ]},
  4:{day:"Thursday",type:"PUSH",color:"#ef4444",icon:"🔴",exercises:[
    {name:"DB Bench Press",sets:"4×10-12",muscle:"Chest",desc:"Dumbbells allow greater range of motion than barbell. Lower deeper, press up and slightly inward. Great for chest activation."},
    {name:"Arnold Press",sets:"4×10-12",muscle:"Shoulders",desc:"Start with palms facing you at shoulder height. Rotate palms outward as you press up. Reverse on the way down. Full shoulder activation."},
    {name:"Cable Flyes",sets:"3×12-15",muscle:"Chest",desc:"Cables at shoulder height. Bring handles together in front of chest in hugging motion. Squeeze chest hard at center."},
    {name:"Front Raises",sets:"3×12-15",muscle:"Front Delts",desc:"Hold dumbbells in front of thighs. Raise one or both arms to eye level, palms down. Control the movement, no swinging."},
    {name:"Dips",sets:"3×10-12",muscle:"Chest/Triceps",desc:"Lean forward slightly for chest focus, stay upright for triceps. Lower until arms at 90°, press up. Add weight when bodyweight gets easy."},
    {name:"Skull Crushers",sets:"3×10-12",muscle:"Triceps",desc:"Lie on bench, hold bar/dumbbells above face. Bend only at elbows, lowering weight towards forehead. Extend back up. Keep elbows still."},
  ]},
  5:{day:"Friday",type:"PULL",color:"#3b82f6",icon:"🔵",exercises:[
    {name:"Barbell Rows",sets:"4×8-10",muscle:"Back",desc:"Second pull day variation: try underhand grip or Pendlay rows (from floor each rep) for different angle and stimulus."},
    {name:"Single Arm DB Row",sets:"3×10-12",muscle:"Lats",desc:"One knee on bench, row dumbbell to hip. Squeeze lat at top. Great for fixing imbalances between sides."},
    {name:"Cable Pullover",sets:"3×12-15",muscle:"Lats",desc:"Stand facing cable machine, straight bar high. Pull bar down in arc motion to thighs, keeping arms nearly straight. Feel the lat stretch."},
    {name:"Reverse Flyes",sets:"3×15",muscle:"Rear Delts",desc:"Bent over or on incline bench. Raise dumbbells out to sides, squeezing rear delts. Light weight, high control."},
    {name:"Incline Curls",sets:"3×10-12",muscle:"Biceps",desc:"Sit on incline bench (~45°). Arms hang straight down. Curl up — the incline pre-stretches the bicep for greater activation."},
    {name:"Concentration Curls",sets:"3×12",muscle:"Biceps",desc:"Sit, elbow braced against inner thigh. Curl dumbbell with full focus on the squeeze. Best isolation exercise for bicep peak."},
  ]},
...
function App(){
  ...
  const getRecommendation=(exName,setIdx)=>{
    ...
    let maxReps=12;for(const day of Object.values(PPL)){for(const ex of day.exercises||[]){if(ex.name===exName){const m=ex.sets.match(/\d+[×x](\d+)(?:-(\d+))?/);if(m)maxReps=parseInt(m[2]||m[1]);break;}}}
    if(prevReps>=maxReps)return{kg:prevKg+2.5,reps:prevReps-2,note:"↑ Weight up!"};
    return{kg:prevKg,reps:prevReps+1,note:"→ Add 1 rep"};
  };
  ...
  const tabs=[{k:"quests",i:"⚔️",l:"QUESTS"},{k:"training",i:"🏋️",l:"PPL"},{k:"learn",i:"🤖",l:"LEARN"},{k:"life",i:"🧠",l:"LIFE"},{k:"social",i:"🤝",l:"SOCIAL"},{k:"health",i:"⚖️",l:"HEALTH"},{k:"rank",i:"📊",l:"RANK"},{k:"settings",i:"⚙️",l:"SAVE"}];
              ...
              return(<div key={i}>
                <div style={{display:"flex",alignItems:"center",gap:8,padding:"9px 10px",marginBottom:2,background:dn?`${vPPL.color}10`:"rgba(255,255,255,.02)",border:dn?`1px solid ${vPPL.color}33`:"1px solid rgba(255,255,255,.04)",borderRadius:6}}>
                  ...
                  <div style={{display:"flex",flexDirection:"column",alignItems:"flex-end",gap:2}}>
                    ...
                    {!dn&&<button onClick={()=>setEditingEx(isEditing?null:`${selPPL}-${i}`)} style={{fontSize:8,color:vPPL.color,background:"none",border:"none",cursor:"pointer",padding:0,fontFamily:"'Courier New',monospace"}}>{isEditing?"▾ Close":"▸ Log sets"}</button>}
                  </div>
                </div>
                  ...
                  const SetLogger=()=>{
                    const [sets,setSets]=useState(()=>{
                      ...
                      for(let s=0;s<numSets;s++){
                        ...
                        arr.push({kg:rec?String(rec.kg):last?String(last.kg):"",reps:rec?String(rec.reps):last?String(last.reps):""});
                      }
                      return arr;
                    });
                    return(<div style={{padding:"10px",marginBottom:4,background:`${vPPL.color}08`,border:`1px solid ${vPPL.color}22`,borderRadius:6}}>
                      ...
                      <div style={{display:"flex",gap:4,marginBottom:6,fontSize:8,color:"#475569"}}>
                        <div style={{width:30,textAlign:"center"}}>Set</div>
                        <div style={{flex:1,textAlign:"center"}}>kg</div>
                        <div style={{flex:1,textAlign:"center"}}>Reps</div>
                        {lastSess&&<div style={{width:50,textAlign:"center"}}>Tip</div>}
                      </div>
                      {sets.map((s,si)=>{
                        const rec=getRecommendation(ex.name,si);
                        return(<div key={si} style={{display:"flex",gap:4,marginBottom:4,alignItems:"center"}}>
                          <div style={{width:30,textAlign:"center",fontSize:10,color:vPPL.color,fontWeight:700}}>{si+1}</div>
                          <input type="number" value={s.kg} placeholder="kg" onChange={e=>{const n=[...sets];n[si]={...n[si],kg:e.target.value};setSets(n);}}
                          ...
                          <input type="number" value={s.reps} placeholder="reps" onChange={e=>{const n=[...sets];n[si]={...n[si],reps:e.target.value};setSets(n);}}
                            style={{flex:1,padding:"7px 6px",background:"rgba(0,0,0,.3)",border:`1px solid ${vPPL.color}33`,borderRadius:4,color:"#e2e8f0",fontSize:12,fontFamily:"'Courier New',monospace",outline:"none",textAlign:"center",boxSizing:"border-box"}}/>
                          {lastSess&&<div style={{width:50,fontSize:7,color:rec?.note?.includes("↑")?"#22c55e":"#f59e0b",textAlign:"center"}}>{rec?.note||""}</div>}
                        </div>);
                      })}
                      <button onClick={()=>{const valid=sets.filter(s=>s.kg&&s.reps);if(valid.length===0){setNotif("Enter at least 1 set");return;}logExerciseSets(ex.name,sets.map(s=>({kg:parseFloat(s.kg)||0,reps:parseInt(s.reps)||0})));}}
