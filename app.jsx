...
const PPL = {
  ...
  4: {
    ...
    exercises: [{
      ...
      muscle: "Front Delts",
      rest: 75,
      desc: "Hold dumbbells in front of thighs. Raise one or both arms to eye level, palms down. Control the movement, no swinging."
    }, {
      name: "Dips",
      sets: "3×10-12",
      muscle: "Chest/Triceps",
      rest: 120,
      desc: "Lean forward slightly for chest focus, stay upright for triceps. Lower until arms at 90°, press up. Add weight when bodyweight gets easy."
    }, {
      name: "Skull Crushers",
      sets: "3×10-12",
      muscle: "Triceps",
...
const LIFE_Q_FIXED = [{
  ...
  xp: 20,
  icon: "🤸",
  desc: "Stretch, foam roll, joint mobility"
}];
...
const BONUS_Q = [{
  ...
  icon: "🪨",
  days: [1, 4],
  desc: "Core priority - post Push day"
}, {
  id: "farmercarry",
  label: "Farmer Carries (3x40m)",
  stat: "VIT",
  xp: 35,
  icon: "💼",
  days: [2, 5],
  desc: "Core + grip - post Pull day"
}, {
  id: "pushups",
  label: "100 Push-ups",
  stat: "STR",
...
const WEEKLY_OBJ = [{
  ...
  id: "oldfriend",
  label: "Meet an Old Friend",
  icon: "🤝",
  xp: 30,
  stat: "PER"
}, {
  id: "nature",
  label: "Outdoor Walk / Nature",
  icon: "🌿",
  xp: 20,
  stat: "PER"
}, {
...
const MUSCLE_GROUPS = [{
  ...
  name: "Chest",
  icon: "🫁",
  exercises: ["Bench Press", "DB Bench Press", "DB Incline Bench Press", "Incline DB Press", "Cable Flyes", "Dips"]
}, {
  key: "back",
  name: "Back",
  icon: "🔙",
  ...
  name: "Shoulders",
  icon: "🔺",
  exercises: ["Overhead Press", "Arnold Press", "Lateral Raises", "Front Raises", "Face Pulls", "Reverse Flyes"]
}, {
  key: "biceps",
  name: "Biceps",
  icon: "💪",
  ...
  name: "Triceps",
  icon: "🔱",
  exercises: ["Tricep Pushdowns", "Overhead Tricep Ext.", "Skull Crushers", "Dips"]
}, {
  key: "quads",
  name: "Quads",
  icon: "🦵",
...
function App() {
    ...
    (async () => {
      ...
      if (S.lastDailyReset && S.lastDailyReset !== today) {
        ...
        if (wasWeekend || wasVacation) {
          ...
          if (!S.dailyLessonDone) {
            totalPenalty += 45;
            missedCount += 1;
            details.push(`lesson (-45)`);
          }
          if (totalPenalty > 0) {
  ...
  const vPPL = ACTIVE_SPLIT[selPPL];
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDFD6\uFE0F Tap to enable vacation mode"), tab === "quests" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    return todaysBonus.map(q => /*#__PURE__*/React.createElement("button", {
      key: q.id,
      onClick: () => toggleQ(q.id),
      style: {
        display: "flex",
    ...
    }, "Last: ", lastSess.sets.map((s, si) => `${s.kg}kg×${s.reps}`).join(" · "))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
    ...
    }, EXERCISE_ALTERNATIVES[ex.name] && /*#__PURE__*/React.createElement("button", {
      onClick: () => setSwapModal(ex.name),
      style: {
        fontSize: 8,
        color: "#a78bfa",
        background: "none",
    ...
    }, isEditing ? "▾ Close" : "▸ Log sets")))), isEditing && (() => {
      const SetLogger = () => {
        ...
        const logSingleSet = si => {
          const s = sets[si];
          if (!s.kg || !s.reps) {
            setNotif("Enter kg and reps for this set");
            return;
          }
          const newSets = [...sets];
          newSets[si] = {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            style: {
              width: 24,
              padding: "7px 0",
              background: s.failed ? "rgba(239,68,68,.3)" : "rgba(0,0,0,.3)",
              border: `1px solid ${s.failed ? "#ef4444" : "rgba(255,255,255,.1)"}`,
              borderRadius: 4,
              color: s.failed ? "#ef4444" : "#475569",
              fontSize: 11,
              cursor: s.logged ? "default" : "pointer",
              fontFamily: "inherit"
            }
          }, s.failed ? "💀" : "○"), /*#__PURE__*/React.createElement("button", {
            onClick: () => logSingleSet(si),
            disabled: s.logged,
            style: {
              width: 30,
              padding: "7px 0",
  ...
  }, "\uD83C\uDFC3 + 1 HR TREADMILL after session")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 14
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    if (ab) {
      ...
      }, ab.target.type === "lift" && `${ab.target.exercise} ${ab.target.kg}kg × ${ab.target.reps} reps`, ab.target.type === "streak" && `${ab.target.days} day streak`, ab.target.type === "muscleXp" && `${ab.target.muscle} ${ab.target.amount}+ XP`, ab.target.type === "deload" && `${ab.target.days} deload days`)), /*#__PURE__*/React.createElement("div", {
        style: {
          padding: "6px 8px",
          background: "rgba(0,0,0,.3)",
          borderRadius: 5
      ...
      }, "\uD83C\uDFC6 Reward: +", ab.reward.xp, " XP \xB7 \"", ab.reward.badge, "\" badge"), /*#__PURE__*/React.createElement("button", {
        onClick: () => {
  ...
  }, "\u2197"))))), tab === "learn" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: "linear-gradient(135deg,rgba(168,85,247,.08),rgba(59,130,246,.05))",
      border: "1px solid rgba(168,85,247,.2)",
      borderRadius: 8,
  ...
  }, "\uD83E\uDD16 CLAUDE MASTERY PATH"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: "#475569"
    }
  }, tLC, "/56 lessons \xB7 Week ", curWk + 1, "/8"), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 5,
      background: "rgba(255,255,255,.05)",
      borderRadius: 3,
    ...
    const wd = w.lessons.every((_, di) => doneLessons.includes(`${i}-${di}`));
    return /*#__PURE__*/React.createElement("button", {
      key: i,
      onClick: () => setLW(i),
      style: {
        ...
        borderRadius: 5,
        cursor: "pointer",
        background: lW === i ? `${w.color}18` : "rgba(255,255,255,.02)",
        border: lW === i ? `1px solid ${w.color}55` : "1px solid rgba(255,255,255,.04)",
        color: lW === i ? w.color : "#475569",
        fontSize: 8,
        textAlign: "center"
      }
    }, /*#__PURE__*/React.createElement("div", null, wd ? "✓" : `W${i + 1}`));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "linear-gradient(135deg,rgba(15,23,42,.9),rgba(30,41,59,.6))",
      border: `1px solid ${LP[lW].color}33`,
      borderRadius: 10,
      padding: 14
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, LP[lW].title), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: "#475569",
      marginBottom: 12
    }
  }, LP[lW].lessons.filter((_, di) => doneLessons.includes(`${lW}-${di}`)).length, "/7 lessons"), LP[lW].lessons.map((ls, di) => {
    const k = `${lW}-${di}`;
    const dn = doneLessons.includes(k);
    const isExp = expandedLesson === k;
    const col = LP[lW].color;
    return /*#__PURE__*/React.createElement("div", {
      key: di,
      style: {
        marginBottom: 4
      ...
      onClick: () => setExpandedLesson(isExp ? null : k),
      style: {
        display: "flex",
        alignItems: "flex-start",
        gap: 8,
        width: "100%",
        padding: "10px 10px",
        background: dn ? `${col}10` : "rgba(255,255,255,.02)",
        border: dn ? `1px solid ${col}33` : "1px solid rgba(255,255,255,.04)",
        borderRadius: 6,
        cursor: "pointer",
        textAlign: "left",
        color: "inherit",
      ...
      style: {
        ...
        borderRadius: 9,
        flexShrink: 0,
        border: dn ? `2px solid ${col}` : "2px solid rgba(255,255,255,.12)",
        background: dn ? `${col}22` : "transparent",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        marginTop: 1
    ...
    }, di + 1)), /*#__PURE__*/React.createElement("div", {
      style: {
        flex: 1
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, ls.title), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 9,
        color: "#334155",
        marginTop: 2
      }
    }, ls.desc), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 8,
        color: col,
        marginTop: 3
      }
    }, isExp ? "▾ Tap to collapse" : "▸ Tap to read full lesson", " \xB7 +45 XP"))), isExp && /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "12px",
        marginTop: 2,
        marginBottom: 4,
    ...
    }, ls.full), !dn && /*#__PURE__*/React.createElement("button", {
      onClick: () => completeL(lW, di),
      style: {
        marginTop: 10,
        width: "100%",
        padding: "10px",
    ...
    }, "\u2713 MARK LESSON COMPLETE (+45 XP)"), dn && /*#__PURE__*/React.createElement("div", {
      style: {
        marginTop: 8,
        textAlign: "center",
        fontSize: 10,
  ...
  }))), tab === "life" && /*#__PURE__*/React.createElement("div", null, getTodayLearning() && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: "#334155",
      letterSpacing: 2,
  ...
  }, b.pages, " pages")))))), tab === "social" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\uD83E\uDD1D DAILY CONNECTION GOAL"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: "#475569",
      marginTop: 2
    }
  }, "This week: ", socialLog.length, " connections")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "rgba(255,255,255,.02)",
      border: "1px solid rgba(255,255,255,.06)",
      borderRadius: 8,
    ...
    style: {
      ...
      fontSize: 9,
      cursor: "pointer",
      background: sT === x.t ? "rgba(236,72,153,.12)" : "rgba(255,255,255,.02)",
      border: sT === x.t ? "1px solid rgba(236,72,153,.3)" : "1px solid rgba(255,255,255,.05)",
      color: sT === x.t ? "#f472b6" : "#475569",
      textAlign: "center"
    }
  }, x.e, /*#__PURE__*/React.createElement("br", null), x.t))), /*#__PURE__*/React.createElement("button", {
    onClick: addSoc,
    style: {
      width: "100%",
      padding: "9px",
      background: "linear-gradient(135deg,rgba(236,72,153,.2),rgba(168,85,247,.1))",
  ...
  }, "\uD83E\uDD1D LOG (+20 XP)")), socialLog.length > 0 && /*#__PURE__*/React.createElement("div", null, socialLog.slice().reverse().map((s, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: "flex",
      justifyContent: "space-between",
  ...
  }, s.type === "message" ? "💬" : s.type === "call" ? "📞" : s.type === "meetup" ? "🫂" : "☕"))))), tab === "health" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      background: "linear-gradient(135deg,rgba(34,197,94,.08),rgba(59,130,246,.05))",
      border: "1px solid rgba(34,197,94,.2)",
      borderRadius: 8,
  ...
  }, progress.toFixed(0), "% to goal \xB7 ", (latestW.weight - goalW).toFixed(1), "kg remaining")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 9,
      color: "#334155",
      letterSpacing: 2,
    ...
    }, swapModal), " for today only"), alts.map((a, i) => /*#__PURE__*/React.createElement("button", {
      key: i,
